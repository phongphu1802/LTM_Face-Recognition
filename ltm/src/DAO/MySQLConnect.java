...
public class MySQLConnect {
    ...
    String Database="LTM";
    String url="jdbc:sqlserver://localhost:1433;databaseName=LTM;user=sa;password=123456789";
...
//            this.url = "jdbc:sqlserver://" + this.Host + ";integratedSecurity=true;databaseName="+ this.Database+";user="+this.UserName+";password="+this.Password;
